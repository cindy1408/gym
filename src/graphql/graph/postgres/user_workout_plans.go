...
func ValidateUserWorkoutPlan(userEmail string, gymDay string) (string, bool) {
...
func AssignUserWorkoutPlan(input model.AddUserWorkoutInput) (*model.UserWorkoutPlan, error) {
